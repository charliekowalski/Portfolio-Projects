...
#define UE_PROJECT_NAME PP3_FPS_Survios
#define UE_TARGET_NAME PP3_FPS_SurviosEditor
#define UE_MODULE_NAME "PP3_FPS_Survios"
...
#define PP3_FPS_SURVIOS_API DLLEXPORT
